...
Nvim-treesitter is based on three interlocking features: [**language parsers**](https://github.com/#language-parsers), [**queries**](#adding-queries), and [**modules**](#available-modules), where _modules_ provide features – e.g., highlighting – based on _queries_ for syntax objects extracted from a given buffer by _language parsers_.
